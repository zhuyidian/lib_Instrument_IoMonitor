...
void Init(JNIEnv *env) {
    jniEnv = env;
    // 拿到 mid
    file_io_monitor_java_class = jniEnv->FindClass("com/darren/optimize/day15/FileIOMonitor");
...
Java_com_darren_optimize_day15_FileIOMonitor_hook(JNIEnv *env, jclass clazz) {
